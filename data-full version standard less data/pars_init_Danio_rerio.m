...
par.z = 0.5264;       free.z     = p;   units.z = '-';            label.z = 'zoom factor'; 
par.F_m = 6.5;        free.F_m   = 0;   units.F_m = 'l/d.cm^2';   label.F_m = '{F_m}, max spec searching rate'; 
par.kap_X = 0.3163;   free.kap_X = p;   units.kap_X = '-';        label.kap_X = 'digestion efficiency of food to reserve'; 
par.kap_P = 0.1000;   free.kap_P = p;   units.kap_P = '-';        label.kap_P = 'faecation efficiency of food to faeces'; 
par.v = 0.02014;      free.v     = p;   units.v = 'cm/d';         label.v = 'energy conductance'; 
par.kap = 0.3056;     free.kap   = p;   units.kap = '-';          label.kap = 'allocation fraction to soma'; 
par.kap_R = 0.95;     free.kap_R = 0;   units.kap_R = '-';        label.kap_R = 'reproduction efficiency'; 
par.p_M = 65.5502;    free.p_M   = p;   units.p_M = 'J/d.cm^3';   label.p_M = '[p_M], vol-spec somatic maint'; 
par.p_T = 0;          free.p_T   = 0;   units.p_T = 'J/d.cm^2';   label.p_T = '{p_T}, surf-spec somatic maint'; 
par.k_J = 0.002;      free.k_J   = 0;   units.k_J = '1/d';        label.k_J = 'maturity maint rate coefficient'; 
par.E_G = 5127.2141;  free.E_G   = p;   units.E_G = 'J/cm^3';     label.E_G = '[E_G], spec cost for structure'; 
par.E_Hb = 2.826e-00; free.E_Hb  = p;   units.E_Hb = 'J';         label.E_Hb = 'maturity at birth'; 
par.E_Hj = 1.036e+01; free.E_Hj  = p;   units.E_Hj = 'J';         label.E_Hj = 'maturity at metam'; 
par.E_Hp = 3.444e+03; free.E_Hp  = p;   units.E_Hp = 'J';         label.E_Hp = 'maturity at puberty'; 
...
par.f_BeauGous2015L = 1.0000;     free.f_BeauGous2015L = e;   units.f_BeauGous2015L = '-';  label.f_BeauGous2015L = 'sc. func. resp., BeauGous2015'; 
par.f_BeauGous2015R = 1.0000;     free.f_BeauGous2015R = e;   units.f_BeauGous2015R = '-';  label.f_BeauGous2015R = 'sc. func. resp., BeauGous2015'; 
