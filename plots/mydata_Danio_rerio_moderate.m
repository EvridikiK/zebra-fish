...
data.Lp = 3.25; units.Lp = 'cm'; label.Lp = 'total length at puberty';bibkey.Lp = 'EatoFarl1974a';
...
temp.tWw_BagaPels2001 = C2K(25);  units.temp.tWw_BagaPels2001 = 'K'; label.temp.tWw_BagaPels2001 = 'temperature';
...
metaData.grp.subtitle = {subtitle3};
